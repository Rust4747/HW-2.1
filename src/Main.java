...
public class Main {
    public static void main(String[] args) {
        ...
        Auto lada = new Auto("Lada ","Granta ","1,7L","Желтая",2015,"сборка Россия");
        Auto audi = new Auto("Audi ","А8 50 L TDI quattro","3,0L","Черный",2021,"сборка Германия");
        Auto bmw = new Auto("BMW ","Z8 ","3,0L","Черный",2021,"сюорка Германия");
        Auto kia = new Auto("Kia ","Sportage 4-го поколения ","2,4L","Красный",2018,"сборка Корея");
        Auto hyundai = new Auto("Hyundai ","Avante ","1,6L","Оранжевый",2016,"сборка Корея");
